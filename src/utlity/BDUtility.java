...
public class BDUtility {
    ...
    public static void openForm (String formName, JFrame fromInstance){
        ...
        if(existingForm==null || !existingForm.isVisible()){
            formsMap.put(formName,fromInstance);
    ...
    public static BufferedImage scaleImage(BufferedImage originalImage,BufferedImage selectedImage){
        ...
        BufferedImage scaldImage= new BufferedImage(width,height,originalImage.getType());
        scaldImage.createGraphics().drawImage(originalImage.getScaledInstance(width, height,Image.SCALE_SMOOTH), 0,0,null);
        return scaldImage;
    }
}
